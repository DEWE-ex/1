  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center p-4">
      ...
      <div className="glass-panel relative z-10 w-full max-w-md text-center">
        ...
        <Link
          href="/admin"
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl py-3 text-sm font-medium text-stone-500 transition hover:bg-white/40 hover:text-stone-700 dark:hover:bg-cold-800/40 dark:hover:text-slate-300"
        >
