...
const features = [
  ...
  },
  {
    ...
    desc: "Viết bài, tim, lưu và bình luận. Bài nhiều tim lên đầu bảng tin.",
  ...
  },
  {
    ...
    desc: "Khóa màn hình, gắn YouTube nhạc nền, tập trung đọc và mở khóa thành tựu.",
  ...
  },
  {
    icon: Gamepad2,
    title: "Karuta 1 vs 1",
    desc: "Ghép ngẫu nhiên hoặc tạo phòng. Âm thanh karuta sống động khi chơi.",
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              type="button"
              onClick={finish}
              className="mt-4 text-xs text-stone-400 underline-offset-2 hover:text-stone-600 hover:underline dark:hover:text-slate-300"
            >
              Bỏ qua giới thiệu
            </button>
          </div>
