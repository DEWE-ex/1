    ...
    <KarutaShell size="lobby">
      <div ref={pageRef} className="space-y-4">
        ...
        <button
          ...
          className="group w-full rounded-2xl bg-amber-500 p-5 text-left shadow-glow transition hover:bg-amber-600 active:scale-[0.98] disabled:opacity-50 dark:bg-cyan-500 dark:shadow-glow-cold dark:hover:bg-cyan-600"
        >
