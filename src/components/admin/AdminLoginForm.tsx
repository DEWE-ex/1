  ...
  return (
    <div className="glass-panel mx-auto max-w-md">
      <div className="mb-6 flex items-center gap-3">
        <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-xl bg-white shadow-md dark:bg-cold-800">
          <img src="/favicon.png" alt="BookFinder" className="h-full w-full object-cover" />
        </div>
        <div>
          <h2 className="text-xl font-bold">Đăng nhập Admin</h2>
          <p className="text-sm text-stone-500 dark:text-slate-400">
            Duyệt câu hỏi Karuta · Quản lý bài viết
          </p>
        </div>
      </div>
