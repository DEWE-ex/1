  ...
  return (
    <div className="relative flex min-h-screen">
      ...
      >
        ...
        >
          <div className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-white shadow-sm dark:bg-cold-800">
            <img
              src="/favicon.png"
              alt="BookFinder"
      ...
      <header className="glass fixed left-0 right-0 top-0 z-40 flex items-center justify-between px-3 py-2.5 md:hidden">
        <div className="flex items-center gap-2">
          <img src="/favicon.png" alt="BookFinder" className="h-5 w-5" />
